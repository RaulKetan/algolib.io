              ...
              <div>
                ...
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center text-primary group-hover:scale-110 transition-transform duration-300">
                      <Calendar className="w-6 h-6" />
                    </div>
                    <div>
                      <span className="text-[10px] text-zinc-400 dark:text-zinc-500 font-bold uppercase tracking-widest block">BOOTCAMP TRACK</span>
                      <h3 className="text-lg font-extrabold tracking-tight text-zinc-800 dark:text-white">7-Day Bootcamp</h3>
                    </div>
                  </div>
                ...
                <p className="text-zinc-600 dark:text-zinc-400 text-sm sm:text-base mb-10 leading-relaxed font-medium">
                ...
                <div className="mb-10 bg-white dark:bg-zinc-950/80 border border-zinc-200 dark:border-zinc-900/60 p-5 rounded-2xl">
                  ...
                  <div className="flex items-center justify-between relative">
                    {/* Connecting line */}
                    <div className="absolute top-4 left-4 right-4 h-[2px] bg-zinc-100 dark:bg-zinc-800 z-0"></div>
                    ...
                    {BOOTCAMP_DAYS.map((day, idx) => {
                      ...
                      return (
                        <div key={idx} className="relative z-10 flex flex-col items-center group/day cursor-pointer">
                          ...
                          <span className={`text-[9px] mt-2 font-bold tracking-tight ${isActive ? "text-primary font-black" : "text-zinc-400 dark:text-zinc-500"} hidden sm:block truncate max-w-[64px]`}>
                            Day {day.day}
                          </span>
                        </div>
                      );
          ...
          >
            ...
            <div className="relative h-full bg-zinc-50/50 dark:bg-[#080808]/90 backdrop-blur-xl border border-zinc-200 dark:border-zinc-800/80 rounded-[30px] p-8 sm:p-10 flex flex-col justify-between overflow-hidden shadow-2xl">
              ...
              <div>
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center text-zinc-400 group-hover:scale-110 transition-transform duration-300">
                      <Building2 className="w-6 h-6" />
                    </div>
                    <div>
                      <span className="text-[10px] text-zinc-400 dark:text-zinc-500 font-bold uppercase tracking-widest block">TARGET PREPARATION</span>
                      <h3 className="text-lg font-extrabold tracking-tight text-zinc-800 dark:text-white">Solve Company Wise</h3>
                    </div>
                  </div>
                </div>
                  ...
                  {TOP_TRACK_COMPANIES.map((company, index) => (
                    ...
                    >
                      <CompanyIcon
                        ...
                        forceLoad={true}
                      />
                      <span className="text-[10px] font-bold text-zinc-600 dark:text-zinc-400 group-hover/pill:text-zinc-900 dark:group-hover/pill:text-white truncate max-w-full">
                        {company.name}
                      </span>
                    </Link>
                  ))}
